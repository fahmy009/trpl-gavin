 ...
 * @author Vin
 */
public class m_stokLogistik extends modelInheritance {

    private koneksi kon;

    public m_stokLogistik() throws SQLException {
        super();
    ...
    public boolean delete(String query) throws SQLException {
        String queries = "DELETE FROM tb_stokgudang WHERE id_permintaan =" + query;
    ...
    public boolean save(String query) throws SQLException {
        String queries = "INSERT INTO tb_laporan (id_permintaan, id_cabang, sosro, fruittea, tebs, stee, tanggal)"
                + " SELECT id_permintaan, id_cabang, sosro, fruittea, tebs, stee, tanggal FROM tb_stokgudang where id_permintaan=" + query;
