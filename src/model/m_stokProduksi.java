 ...
 * @author Vin
 */
public class m_stokProduksi extends modelInheritance{
     private koneksi kon;

    public m_stokProduksi() throws SQLException {
        super();
    ...
    public boolean delete(String query) throws SQLException {
        String queries = "DELETE FROM tb_permintaangudang WHERE id_permintaan =" + query;
    ...
    public boolean save(String query) throws SQLException {
        String queries = "INSERT INTO tb_stokproduksi (id_permintaan, id_cabang, sosro, fruittea, tebs, stee, tanggal)"
                + " SELECT id_permintaan, id_cabang, sosro, fruittea, tebs, stee, tanggal FROM tb_permintaangudang where id_permintaan=" + query;
